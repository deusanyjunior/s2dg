...
import org.ufpb.s2dg.session.beans.CalendarAlunoBean;
import org.ufpb.s2dg.session.beans.UsuarioBean;
import org.ufpb.s2dg.session.util.ItemDeCalendario.TipoData;


@Name("calendarAlunoDataModel")
@AutoCreate
public class CalendarAlunoDataModelImpl implements CalendarDataModel {

	@In
	Fachada fachada;

	@In
	CalendarAlunoBean calendarAlunoBean;
	...
	public void valueChanged(ValueChangeEvent event) {		
		calendarAlunoBean.setSelectedDate((Date)event.getNewValue());		
	}
